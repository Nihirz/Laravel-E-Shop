        ...
        <div class="container mt-4">
            <div class="card">
                ...
                <div class="card-header" style="background-color: #404040; color: white;">Edit About
                 ...
                 <form class="form-horizontal style" method="POST" enctype="multipart/form-data" action="{{route('update.logo')}}">

                  @csrf
                  <input type="hidden" name="id" value="{{$logo->id}}">
                    <div class="card-body">
                        <div class="form-row">
                            <span class="border border-dark p-3"><img src="{{asset('uploads/'. $logo->image)}}" style="width:200px; height:200px"></span>
                         </div>
                            <div class="form-row">
                            <div class="form-group col-md-6">

                              <label for="customerDetailsCustomerFullName">Logo Image</label>
